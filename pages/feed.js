...
function FeedForm() {
  const [state, handleSubmit] = useForm("mknavddd");
  ...
  if (state.succeeded) {
    return <><p className='
        ...
        text-pink-500
        '>
          You are the one who is going to make a difference in someone's life. Thank you for your contribution.
        </p>
        <p className='
        text-center text-2xl
        text-green-500
